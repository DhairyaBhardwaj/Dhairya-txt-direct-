...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8331202838:AAHpJ6HT0s_Uh4tqU70Nt6KkxuNZ5bCgJ38")
    API_ID = int(os.environ.get("API_ID",  "27498866"))
    API_HASH = os.environ.get("API_HASH", "96fbb6ad2e11ab04e83ca09ef3f42455")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    SESSIONS = "./SESSIONS"

    AUTH_USERS = os.environ.get('AUTH_USERS', '5968801459').split(',')
    for i in range(len(AUTH_USERS)):
        AUTH_USERS[i] = int(AUTH_USERS[i])

    GROUPS = os.environ.get('GROUPS', '-1003169727261').split(',')
    for i in range(len(GROUPS)):
        GROUPS[i] = int(GROUPS[i])

    LOG_CH = os.environ.get("LOG_CH", "-1002903792997")
